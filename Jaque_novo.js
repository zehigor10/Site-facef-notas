...
function mostraAlunos() {
    ...
    for (let i = 0; i < this.listaInstanciada.returnLength(); i++) {
        let elements = document.getElementById('showCard').innerHTML += "<div class='containerAluno' id='containerAlunoId'><div class='nomeCodigo'><h4>" + current.aluno.nome + "</h4><div class='divisao'>|</div><h4>" + current.aluno.codigo + "</h4></div><table style='width:100%'><tr><th>Disciplina</th><th>1º Bimestre</th><th>2º Bimestre</th><th>Frequência</th><th>Situação</th></tr><tr><td>" + current.aluno.curso + "</td><td>" + current.aluno.notaA + "</td><td>" + current.aluno.notaB + "</td><td>" + current.aluno.frequencia + "%" + "</td><td id='corSituacao" + i + "'>" + current.aluno.situacao + "</td></tr></table></div>"
...
function mostraPesquisa(alunoPesquisado) {
    document.getElementById('showCard').innerHTML += "<div class='containerAluno' id='containerAlunoId'><div class='nomeCodigo'><h4>" + alunoPesquisado.nome + "</h4><div class='divisao'>|</div><h4>" + alunoPesquisado.codigo + "</h4></div><table style='width:100%'><tr><th>Disciplina</th><th>1º Bimestre</th><th>2º Bimestre</th><th>Frequência</th><th>Situação</th></tr><tr><td>" + alunoPesquisado.curso + "</td><td>" + alunoPesquisado.notaA + "</td><td>" + alunoPesquisado.notaB + "</td><td>" + alunoPesquisado.frequencia + "</td><td id='corSituacao'>" + alunoPesquisado.situacao + "</td></tr></table></div>"
